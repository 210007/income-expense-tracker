  ...
  return (
    <main className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-semibold">Edit Recurring Invoice</h1>
      </div>
      ...
      <div className="grid gap-5 max-w-2xl">
        <div className="border rounded-xl p-5 grid gap-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <label className="text-sm opacity-60 block mb-1">Next Run Date</label>
              <input type="date" className="w-full border rounded px-3 py-2 bg-transparent text-sm" value={nextRunDate} onChange={(e) => setNextRunDate(e.target.value)} />
            </div>
            <div>
          ...
          <label className="flex items-center gap-3 cursor-pointer select-none">
            ...
            <div>
              ...
              <p className="text-xs opacity-50">Automatically emails the invoice to the customer when generated</p>
            </div>
          </label>
        </div>
